  ...
  public getStatus(): Observable<ApplicationResponse> {
    return this.userContextService.getUserToken().pipe(
      switchMap((accessToken) => {
        ...
        // return of({ id: "1", phoneNumber: "9999999", email: "kasia@wp.pl", status: "Oczekiwanie", universities: [{ name: "Uniwersytet Pedagogiczny", city: "Kraków" }, { name: "Politechnika Krakowska", city: "Kraków" }] });
